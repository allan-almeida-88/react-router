import { IconActivity, IconDirectionSign, IconFileAlert, IconForms, IconLayoutNavbar, IconLayoutNavbarCollapse, IconMenu, IconRoute, IconSearch, IconX } from "@tabler/icons-react";
